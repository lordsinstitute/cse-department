...
def live_data():
    ...
    return jsonify({
        "switch": 1,
        "pktcount": random.randint(50, 500),
        "bytecount": random.randint(1000, 10000),
        "dur": random.randint(1, 20),
        "dur_nsec": random.randint(10, 100),
        "flows": random.randint(1, 10),
        "pktrate": random.randint(10, 200),
        "pairflow": random.randint(1, 5),
        "port_no": random.randint(1, 4),
        "tx_bytes": random.randint(1000, 5000),
        "rx_bytes": random.randint(1000, 5000),
        "tx_kbps": random.randint(50, 200),
        "rx_kbps": random.randint(50, 200)
    })
