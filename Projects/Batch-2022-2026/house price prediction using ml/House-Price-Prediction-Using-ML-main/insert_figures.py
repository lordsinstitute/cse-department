"""Insert all figures into C4 House Price Prediction Report."""
...
CH4_MAP = {
    ...
    'Fig 4.7: ML Pipeline / Data Flow Diagram': ('fig_4_7_ml_pipeline.png', 5.5),
...
CH7_MAP = {
    ...
    'Fig 7.5:': ('fig_7_5_result.png', 5.5),
    'Fig 7.6:': ('fig_7_6_history.png', 5.5),
    'Fig 7.7:': ('fig_7_7_visualize.png', 5.5),
    'Fig 7.8:': ('fig_7_8_dashboard.png', 5.0),
    'Fig 7.9:': ('fig_7_9_about.png', 5.0),
...
for i, para in enumerate(doc.paragraphs):
    ...
    if '1.5' in text and 'Existing System' in text and not fig_1_1_done:
        ...
        if os.path.exists(img_path):
            ...
            cap_run = cap_para.add_run('Fig 1.1: Traditional vs ML-Based House Price Estimation')
