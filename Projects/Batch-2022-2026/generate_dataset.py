...
## To run this project,
# cd "AI-Based-Medical-Image-Analysis-Using-Deep-Learning-main"
# python train_model.py
## or

# cd "AI-Based-Medical-Image-Analysis-Using-Deep-Learning-main"; python train_model.py
# Then next
# python app.py
# After running the app, open your web browser and navigate to http://127.0.0.1:5010
# The Flask app is now running successfully on http://127.0.0.1:5010 (also accessible at http://192.168.1.4:5010). Open this URL in your browser to access the web interface.

# Default login credentials: Username admin, Password admin123. OR User name Rahman, Password 006006python tools/generate_presentation.py
# The app is in debug mode; press Ctrl+C in the terminal to stop it when done.